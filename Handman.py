...
class HangmanGame:
    def __init__(self, root):
        self.root = root
        self.root.title("Enhanced Hangman Game")
        ...
        self.attempts_label = tk.Label(root, text="Attempts left: 6", font=("Arial", 16))
        self.attempts_label.place(x=300, y=250)
